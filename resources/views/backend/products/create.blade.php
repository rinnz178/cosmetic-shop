                    ...
                    <div class="card-body mt-5">
                        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10"> <input type="text" name="brand" class="form-control"
                                        placeholder="Brand Name"></div>
                            </div>
                            <div class="row mb-3">
                                <label for="inputText" class="col-sm-2 col-form-label">Price</label>
                                <div class="col-sm-10"> <input type="number" name="price" class="form-control"
                                        placeholder="Price"></div>
                            </div>

                            <div class="row mb-3">
                                <label for="inputText" class="col-sm-2 col-form-label">Quantity</label>
                                <div class="col-sm-10"> <input type="number" name="quantity" class="form-control"
                                        placeholder="Quantity"></div>
                            </div>
                            <div class="row mb-3">
                                <label for="inputText" class="col-sm-2 col-form-label">Skin type</label>
                                <div class="col-sm-10"> <select class="form-select" name="skin_type"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10"> <input type="text" name="skin_care_benefits" class="form-control"
                                        placeholder="Skin Care Benifits"></div>
                            </div>
                            {{-- <div class="row mb-3">
                                <label class="col-sm-2 col-form-label"> Availibility</label>
                                <div class="col-sm-10">
                                    <select class="form-select" name="availibility" aria-label="Default select example">
                                        <option selected>Choose Availibility</option>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10"> <input class="form-control" name="image" type="file"
                                        id="formFile"></div>
                            </div>
                            <div class="row mb-3">
